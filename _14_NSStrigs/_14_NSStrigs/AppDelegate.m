...
//    NSRange range = [text rangeOfString:@" You can determine how many characters"];
//    
//    if (range.location != NSNotFound) {
//       NSString* textToRange = [text substringToIndex:range.location];
//       NSLog(@"%@", textToRange);
//    }else{
...
//    
//    if (range.location != NSNotFound) {
//        NSString* textFromRange = [text substringFromIndex:range.location];
//        NSLog(@"%@", textFromRange);
//    }else{
//        NSLog(@"Range not found");
//    }
    
    NSArray* arrayWithStrings =[text componentsSeparatedByString:@"."];
    
//    NSLog(@"%@",arrayWithStrings);
    
    NSMutableArray* array2 = [[NSMutableArray alloc]init];
    
    for (NSString* string in arrayWithStrings) {

        NSRange searchRange = [string rangeOfString:@"NSString"options: NSCaseInsensitiveSearch];
        
        if (searchRange.location != NSNotFound) {
            NSString* sentence = string;
            [array2 addObject:sentence];
        }
    }
    
    NSString* text3 = [text lowercaseString];
    NSMutableString *reversedString = [NSMutableString stringWithCapacity:[text3 length]];
    
    
    [text3 enumerateSubstringsInRange:NSMakeRange(0,[text3 length])
     ...
     text3 = [reversedString capitalizedString];
     NSMutableString *reversedString1 = [NSMutableString stringWithCapacity:[text3 length]];
    ...
    NSLog(@"%@",reversedString1);
    
    /*
    NSMutableArray* array3 = [[NSMutableArray alloc]init];
    
    for (NSString* string2 in array2) {
         NSRange lastWorld = [string2 rangeOfString:@" " options:NSCaseInsensitiveSearch | NSBackwardsSearch];
         NSRange firstWorld = [string2 rangeOfString:@" " options:NSCaseInsensitiveSearch];
        
         NSString* last = [string2 substringFromIndex:lastWorld.location+1];
         NSString* first = [string2 substringToIndex:firstWorld.location];
        
        
         NSString* string3 = [string2 substringToIndex:lastWorld.location];
                   string3 = [string3 substringFromIndex:firstWorld.location];
        
         NSString* stringTrue = [NSString stringWithFormat:@"%@%@ %@",last,string3,first];
        [array3 addObject:stringTrue];
     }
    NSLog(@"NSString = %d %@", [array3 count],array3);*/
